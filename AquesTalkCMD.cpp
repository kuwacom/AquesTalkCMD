...
int main(int argc, char* argv[])
{
	...
	if ((string)argv[1] == (string)"f1") {
		...
		wav = AquesTalk_SyntheF2(text.c_str(), atoi(argv[2]), &size);
	}
		...
		wav = AquesTalk_SyntheImd1(text.c_str(), atoi(argv[2]), &size);
	}
		...
		wav = AquesTalk_SyntheJgr(text.c_str(), atoi(argv[2]), &size);
	}
		...
		wav = AquesTalk_SyntheDvd(text.c_str(), atoi(argv[2]), &size);
	}
		...
		wav = AquesTalk_SyntheM1(text.c_str(), atoi(argv[2]), &size);
	}
		...
		wav = AquesTalk_SyntheM2(text.c_str(), atoi(argv[2]), &size);
	}
		...
		wav = AquesTalk_SynthePhont(text.c_str(), atoi(argv[2]), &size);
	}
		...
		wav = AquesTalk_SyntheR1(text.c_str(), atoi(argv[2]), &size);
	}
	else {
		cout << -2;
		return -2;
